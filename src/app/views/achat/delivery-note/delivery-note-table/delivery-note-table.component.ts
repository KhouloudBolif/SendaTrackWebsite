...
export class DeliveryNoteTableComponent implements OnChanges {
  ...
  columnNames= ["N BL ", "Date BL", "N commande fournisseur", "fournisseur", "Dépôt", "N facture", "N reglement"]
  displayedColumns = ["deliveryNum", "deliveryDateString", "order_numbers", "id_Contact", "depot", "billNum", "settlementNum"];
