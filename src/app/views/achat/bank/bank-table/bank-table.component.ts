...
export class BankTableComponent implements OnChanges {
  @Input() data=[];
  @Input() pageSizeOptions?= [5, 10, 15, 20, 30, 50, 100, 200, 500, 1000];
  @Input() isEditPermission? = false

  columnNames = ["Banque", "N compte", "Type D'édition", "Solde"]
  displayedColumns =["name", "accountNum", "editionType", "amount"]
