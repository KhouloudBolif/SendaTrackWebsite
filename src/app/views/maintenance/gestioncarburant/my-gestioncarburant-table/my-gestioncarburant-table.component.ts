  ...
  ngOnChanges(changes: SimpleChanges): void {
    ...
    if(changes['isEditPermission']){
      ...
      if(this.isEditPermission){
        this.displayedColumns =[ "actions", 'id', 'driverID','deviceID', 'fournisseur', 'numCarte', 'numBon',  'qte', 'pleinOnStr', 'montant',  'montantTTC', 'kmPrecedent', 'kmEncours', 'consoM', 'dateFill', 'observation' ]
        ...
        this.displayedColumns = ['id', 'driverID','deviceID', 'fournisseur', 'numCarte', 'numBon',  'qte', 'pleinOnStr', 'montant',  'montantTTC', 'kmPrecedent', 'kmEncours', 'consoM', 'dateFill', 'observation' ]
