...
export class ExportingTool {
    ...
    exportPdf_CarteCarburant(data: any[], title: string) {
        ...
        (doc as any).autoTable({
            columns: [
                ...
                { dataKey: "NUMÉRO DE CARTE", header: "NUMÉRO DE CARTE" },
                { dataKey: 'TYPE DE CARTE', header: 'TYPE DE CARTE' },
                { dataKey: 'PLAFOND', header: 'PLAFOND' },
    ...
    exportPdf_Peages(data: any[], title: string) {
        const doc = new jsPDF('l');
        const rows: any = [];
        data.forEach((elt) => {
            const tmp = [
    ...
    exportPdf_Intervention(data: any[], title: string) {
        const doc = new jsPDF();
        const rows: any = [];
        ...
        (doc as any).autoTable({
            columns: [
                ...
                { dataKey: 'IDENTIFIANT', header: 'IDENTIFIANT' },
                { dataKey: 'MATRICULE', header: 'MATRICULE'},
                { dataKey: 'STATUT', header: 'STATUT' },
                { dataKey: 'DATE', header: 'DATE' },
                { dataKey: 'DATES', header: 'DATES' },
                { dataKey: 'DEMANDEUR', header: 'DEMANDEUR' },
                { dataKey: 'DESCRIPTION', header: 'DESCRIPTION' },
                { dataKey: 'TYPE PANNE', header: 'TYPE PANNE' },
                { dataKey: 'TYPE INTERVENTION', header: 'TYPE INTERVENTION' },
            ],
            body: rows,
            theme: 'grid',
            rowPageBreak: 'auto',
