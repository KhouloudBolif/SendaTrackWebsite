...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'gestion_contact',
        loadChildren: () => import('./views/gestionContact/gestionContact.module').then(m => m.GestionContactModule)
      },
      {
        path: 'live-streaming',
        loadChildren: () => import('./views/parametrage/parametrage.module').then(m => m.ParametrageModule)
      ...
      {
        path: 'Lst_Article',
        loadChildren: () => import('./views/LstArticle/LstArticle.module').then(m => m.LstArticletModule)
      },
      {
        path: 'dev-module',
        loadChildren: () => import('./views/dev-module/dev-module.module').then(m => m.DevModuleModule)
      },
      {
        path: 'achat',
